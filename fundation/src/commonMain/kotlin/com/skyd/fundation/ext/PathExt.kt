...
val Path.size: Long
    get() = SystemFileSystem.metadataOrNull(this)?.size ?: 0L
...
}.onFailure { Logger.e(it.message.orEmpty()) }.getOrNull()

fun FileSystem.deleteRecursively(path: Path, mustExist: Boolean = true): Long {
