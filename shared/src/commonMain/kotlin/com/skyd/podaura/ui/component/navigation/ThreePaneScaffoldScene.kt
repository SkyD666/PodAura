...
import androidx.compose.material3.adaptive.navigation3.ListDetailSceneScopeImpl
import androidx.compose.material3.adaptive.navigation3.LocalListDetailSceneScope
import androidx.compose.material3.adaptive.navigation3.LocalSupportingPaneSceneScope
...
import androidx.compose.material3.adaptive.navigation3.MetadataPreferredHeightKey
import androidx.compose.material3.adaptive.navigation3.MetadataPreferredWidthKey
import androidx.compose.material3.adaptive.navigation3.SupportingPaneSceneScopeImpl
import androidx.compose.material3.adaptive.navigation3.ThreePaneScaffoldType
...
// Copied from androidx.compose.material3.adaptive.navigation3.ThreePaneScaffoldScene
// (org.jetbrains.compose.material3.adaptive:adaptive-navigation3:1.3.0-alpha07)
// This ThreePaneScaffoldScene implementation adds animation for detail pane changes.
    ...
    override val content: @Composable () -> Unit = {
        ...
        LaunchedEffect(transitionState) {
            ...
            if (transitionState is NavigationEventTransitionState.InProgress) {
                ...
                // Completed/Canceled: Animate back to the stable state.
            ...
            detailPane = {
                ...
                CompositionLocalProvider(LocalListDetailSceneScope provides sceneScope) {
                    AnimatedPane(
                        ...
                        val transitionSpec = MaterialSharedAxis.X.TransitionSpec
                        val popTransitionSpec = MaterialSharedAxis.X.PopTransitionSpec

                        var prevEntries by remember { mutableStateOf(entries) }
                        val isPush = lastDetail == null || lastDetail !in prevEntries
                        SideEffect { prevEntries = entries }

                        AnimatedContent(
                            targetState = lastDetail,
                            transitionSpec = {
                                if (isPush) transitionSpec else popTransitionSpec
                            }
                        ) { lastDetail ->
